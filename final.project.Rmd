...
```{r reading in the data and merging:}
...
sba_2012 <- read_excel("data/SBA_Disaster_Loan_Data_FY12_simple.xlsx",
                       col_types = c("numeric", "numeric", "numeric", 
                                     ...
                                     "numeric"))
glimpse(sba_2012)
print(list(sba_2012$`Damaged Property Zip Code`))
...
#step 1:
url <- "https://api.census.gov/data/2012/zbp?get=EMP,EMPSZES,ESTAB,GEO_ID,PAYANN,PAYQTR1&for=zip%20code:*&key=ec901d907020e0a48a8035d41c1b35c94c85468e"
...
glimpse(sba_zip1) #to see what the variable is actually named
sba_zip <- sba_zip %>%
...
table(is.na(sba_merged$`Approved Amount Content`))
table(is.na(sba_merged$`Approved Amount EIDL`))
table(is.na(sba_merged$emp))
table(sba_merged$empszes)
